...
export type DisputeStatus = "draft" | "pending_review" | "approved" | "rejected" | "mailed" | "delivered" | "bureau_investigating" | "resolved" | "closed";
export type LetterStatus = "draft" | "pending_approval" | "approved" | "rendering" | "ready" | "queued" | "sent" | "in_transit" | "delivered" | "returned_to_sender";
export type Bureau = "equifax" | "experian" | "transunion";
export type DisputeType = "611_dispute" | "609_request" | "605b_identity_theft" | "reinvestigation" | "goodwill" | "pay_for_delete" | "debt_validation" | "cease_desist";
export type MailType = "usps_first_class" | "usps_certified" | "usps_certified_return_receipt";
export type DisputeOutcome = "corrected" | "verified_accurate" | "deleted" | "pending" | "no_response" | "frivolous";
